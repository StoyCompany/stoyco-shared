...
import 'package:stoyco_shared/radio/radio_tab_controller.dart';

/// Simple radio player widget
///
/// This widget only displays the radio player controls and listener count.
...
class _RadioTabWidgetState extends State<RadioTabWidget> {
  late RadioTabController _controller;

  @override
  void initState() {
    super.initState();
    _controller = RadioTabController(config: widget.config);
  }
  ...
  Widget build(BuildContext context) => ValueListenableBuilder<bool>(
        ...
        builder: (context, isLoading, _) {
          ...
          return ValueListenableBuilder<RadioTabState>(
            valueListenable: _controller.stateListenable,
            builder: (context, state, _) {
              if (state.error != null || state.radios.isEmpty) {
                return const SizedBox.shrink();
              }
...
class RadioPlayerContent extends StatelessWidget {
  ...
  final RadioTabController controller;
  final String? fontFamily;
